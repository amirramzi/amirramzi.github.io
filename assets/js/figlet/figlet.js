...
const figlet = (() => {
  ...
  function _reworkFontOpts(fontMeta, options) {
    ...
    myOpts.printDirection =
      options.printDirection !== null && options.printDirection !== void 0
      ...
      if (
        ...
        const msg =
          parsedNum === -1
            ...
            : `The char code cannot be ${parsedNum < -2147483648 ? 'less than -2147483648' : 'greater than 2147483647'}.`;
...
export { figlet as f, getFontName as g };
